    ...
    void inBounds() {
        {
            ...
            for (int i = 0; i < 13; i++) {
                ...
                assertEquals(new MowerState(Direction.E, new Coordinate(4, 2), 3, 0), states.get(states.size() - 1));
            }
        }
        {                                                           // 1 3  1 4  1 4 E  2 4  3 4
            ...
            for (int i = 0; i < 13; i++) {
                m.processFrom(i);
                var states = m.getStates();
                assertEquals(new MowerState(Direction.E, new Coordinate(3, 4), 5, 1), states.get(states.size() - 1));
            }
        }
    }
    ...
    void outOfBounds() {
        ...
        }
        {
            ...
            for (int i = 0; i < 13; i++) {
                m.processFrom(i);
                var states = m.getStates();
                assertEquals(new MowerState(Direction.E, new Coordinate(1, 1), 10, 0), states.get(states.size() - 1));
            }
        }
